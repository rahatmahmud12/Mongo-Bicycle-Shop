        ...
        <div>
            <div class="flex items-start">
                <div class="flex-shrink-0">
                    <div class="inline-block relative">
                        <div class="relative w-16 h-16 rounded-full overflow-hidden">
                            <img class="absolute top-0 left-0 w-full h-full bg-cover object-fit object-cover" src={user.photoURL} alt="Profile picture" />
                ...
                <div class="ml-6">
                    ...
                    <div class="mt-3">
                        <span class="font-bold">Product Review</span>
