...
const ExtraPart = () => {
    ...
    return (
        ...
        <div className="">
            <h2 className="py-5 text-6xl text-center">Usefulness Of Cycling</h2>
            <div className="min-h-screen bg-blue-500 py-4 flex flex-col align-center justify-center sm:py-12">
